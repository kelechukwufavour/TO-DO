document.addEventListener('DOMContentLoaded', () => {
    ...
    const filterButtons = document.querySelectorAll('.filter-btn'); // Select filter buttons
    const clearCompletedButton = document.getElementById('clear-completed');
    const todoList = document.getElementById('todo-list');
    const newTodoInput = document.getElementById('new-todo');
    const themeToggleButton = document.getElementById('theme-toggle'); // Select theme toggle button
    ...
    function loadThemePreference() {
        ...
        // Check if bgImage exists before trying to set its src
        if (bgImage) {
    ...
    themeToggleButton.addEventListener('click', () => {
        themeToggle.click(); // Trigger the theme toggle click event
    });
    document.getElementById('todo-form').addEventListener('submit', (e) => {
        e.preventDefault(); // Prevent for submission
        addTodo();
    });
